...
class LocalGlobalMapperNode {
 public:
   ...
   */
  LocalGlobalMapperNode(ros::NodeHandle& nh);
 ...
 private:
  ...
  void makeInflatedMap(const std::unique_ptr<mapper::VoxelMapper>& map,
                       planning_ros_msgs::VoxelMap& voxel_map);

  // TODO
  // planning_ros_msgs::VoxelMap makeLocalInflatedMap(
  ...
  planning_ros_msgs::VoxelMap global_map_ros_;
  planning_ros_msgs::VoxelMap storage_map_ros_;
  planning_ros_msgs::VoxelMap local_map_ros_;
